...
created() {
    ...
    this.teachers= [
        {_id: 1, isTeacher: true, name: 'puki', topic:'Maths', price: 90, img: 'https://graph.facebook.com/1908258719448452/picture?type=large'},
        {_id: 2, isTeacher: true, name: 'Shuki', topic:'Dev', price: 110, img: 'https://www.gravatar.com/avatar/ec5ecb12a5198dbb705b12cd0e621235?s=32&d=identicon&r=PG'},
        {_id: 3, isTeacher: true, name: 'muki', topic:'Lang', price: 100, img: 'https://i.stack.imgur.com/zk6Ku.png?s=32&g=1'}
    ]
},
methods: {
    openProfile(id) {
